...
const List<ResumeTemplate> kResumeTemplates = [
  ...
  ResumeTemplate(
    id: 'cascade',
    name: 'Zety Cascade (Dual Sidebar)',
    icon: '🌊',
    description: 'Zety\'s #1 most popular template — left colored sidebar for skills & contact',
    atsScore: 96,
    bestFor: ['Software Developers', 'Designers', 'Marketing', 'Product Managers'],
    categories: ['zety', 'modern'],
  ),
  ResumeTemplate(
    id: 'primo',
    name: 'Zety Primo (Avatar & Badges)',
    icon: '🌟',
  ...
  ResumeTemplate(
    ...
    categories: ['zety', 'creative'],
  ),
  ResumeTemplate(
    id: 'vibes',
    name: 'Zety Vibes (Creative Banners)',
    icon: '🔮',
